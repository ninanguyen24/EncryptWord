...
Legal states: On - when a valid word is pass through the shift function after object is initialize. 
			  ...
			  It is also off when the user wants the original word returned by calling decode or when the object is reset.
			  Decode will maintain guessing stats but reset will return the object to it's original state.
			  The field "state" is set to false once
...
private:
	...
	string word; //word passed through constructor
